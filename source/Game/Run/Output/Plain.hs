...
import Game.Run.Output.Plain.Sound
import Game.Run.Output.Plain.Screen
import OpenGL
...
outputBegin' = \s run b -> do
    ...
    let Shape wth hth = sceneShape $ runScene run
        proj = mat4Perspective valuePerspectiveFOVY
                               ...
                               valuePerspectiveFar
        modv = mat4SceneCamera $ runGrid run
        normal = modv

    io $ do
        outputSoundBegin' gamedata proj modv normal s run b
        outputScreenBegin' gamedata proj modv normal s run b
...
outputMain' = \s run b -> do
    ...
    io $ do
        outputSoundMain' gamedata proj modv normal s run b
        outputScreenMain' gamedata proj modv normal s run b
...
outputEnd' = \s run b -> do
    ...
    io $ do
        outputSoundEnd' gamedata proj modv normal s run b
        outputScreenEnd' gamedata proj modv normal s run b
...
outputAtFace' = \s run b -> do
    ...
    io $ do
        outputSoundAtFace' gamedata proj modv normal s run b 
        outputScreenAtFace' gamedata proj modv normal s run b
...
outputAToB = \s run b -> do
    ...
    io $ do
        outputSoundAToB gamedata proj modv normal s run b
        outputScreenAToB gamedata proj modv normal s run b
