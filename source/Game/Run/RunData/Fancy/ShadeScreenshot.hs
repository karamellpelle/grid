...
loadShadeScreenshot = do
    vsh <- fileStaticData "shaders/Screenshot.vsh"
    fsh <- fileStaticData "shaders/Screenshot.fsh"
    ...
    glVertexAttribPointer attTexCoord 2 gl_UNSIGNED_SHORT gl_FALSE 4 $ mkPtrGLvoid 0
...
unloadShadeScreenshot sh = do
    putStrLn "unloadShadeScreenshot: not implemented"
