...
loadShadeWall = do
    vsh <- fileStaticData "shaders/Wall.vsh"
    fsh <- fileStaticData "shaders/Wall.fsh"
    ...
    -- tmp, set RefDir
    --glProgramUniform3fEXT prg uRefDir 0.4867 0.3244 0.8111
    glProgramUniform3fEXT prg uRefDir 0.0 0.0 1.0
