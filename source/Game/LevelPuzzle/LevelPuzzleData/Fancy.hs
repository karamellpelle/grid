...
--
module Game.LevelPuzzle.LevelPuzzleData.Fancy
  (
    LevelPuzzleData (..),
    ...
    module Game.LevelPuzzle.LevelPuzzleData.Fancy.ShadeWall,
...
import Game.LevelPuzzle.LevelPuzzleData.Fancy.ShadeWall
import Game.LevelPuzzle.LevelPuzzleData.Fancy.ShadeDot
import Game.LevelPuzzle.LevelPuzzleData.Fancy.SoundLevelPuzzle
