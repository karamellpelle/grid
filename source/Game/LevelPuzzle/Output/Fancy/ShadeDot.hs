...
--
module Game.LevelPuzzle.Output.Fancy.ShadeDot
  (
    shadeDotBegin,
    shadeDotEnd,
    shadeDotRadius,
...
shadeDotBegin :: ShadeDot -> Float -> Mat4 -> Mat4 -> IO ()
shadeDotBegin sh alpha projmodv normal = do
...
shadeDotRadius :: ShadeDot -> Float -> IO ()
shadeDotRadius sh radius = do
    glUniform1f (shadeDotUniRadius sh) (rTF radius)
