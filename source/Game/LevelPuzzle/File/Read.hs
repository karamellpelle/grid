...
--
module Game.LevelPuzzle.File.Read
  (
    rLevelPuzzleWorld,
    rLevel,
    rLevelOffset,
...
import Game.LevelPuzzle.File.Field
import Game.LevelPuzzle.File.Version
...
rLevelOffset ix = do
    ...
    -- fixme: this is a bug!!!
    --        since the strings for Creator and Name may contain 'fieldLevelS'
