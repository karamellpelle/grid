...
-- | void ios_keysClear()
foreign import ccall unsafe "ios_keysClear" ios_keysClear
    :: IO ()
...
foreign import ccall unsafe "ios_keysTouchHandlePointTouched" 
    ios_keysTouchHandlePointTouched
...
keysTouchHandlePointTouched a f = io $ do
    allocaArray 2 $ \ptr -> do
        ...
        ios_keysTouchHandlePointTouched ptrX ptrY >>= \value -> case value of
            0   -> return a
            _   -> do
              x <- peek ptrX
              y <- peek ptrY
...
-- | uint ios_keysTouchHandleReleased(float* , float* )
foreign import ccall unsafe "ios_keysTouchHandlePointReleased" 
    ios_keysTouchHandlePointReleased
    :: Ptr CFloat -> Ptr CFloat -> IO CUInt
...
keysTouchHandlePointReleased a f = io $ do
    allocaArray 2 $ \ptr -> do
        let ptrX = advancePtr ptr 0
            ptrY = advancePtr ptr 1
        ios_keysTouchHandlePointReleased ptrX ptrY >>= \value -> case value of
            0   -> return a
            _   -> do
              x <- peek ptrX
              y <- peek ptrY
...
-- | uint ios_keysTouchHandlePointVector(double* ticks, float* x, float* y, float* x1, float* y1)
foreign import ccall unsafe "ios_keysTouchHandlePointDrag" 
    ios_keysTouchHandlePointDrag
...
keysTouchHandlePointDrag a f = io $ do
    alloca $ \ptrTicks -> 
      allocaArray 4 $ \ptr -> do
          ...
          ios_keysTouchHandlePointDrag ptrTicks
                                           ptrX0
                                           ptrY0
                                           ptrX1
...
-- | uint ios_keysTouchHandlePointVector(double* ticks, float* x, float* y, float* x1, float* y1)
foreign import ccall unsafe "ios_keysTouchHandlePointDrop" ios_keysTouchHandlePointDrop
    :: Ptr CDouble -> Ptr CFloat -> Ptr CFloat -> Ptr CFloat -> Ptr CFloat -> IO CUInt
    ...
    alloca $ \ptrTicks -> 
      allocaArray 4 $ \ptr -> do
          let ptrX0 = advancePtr ptr 0
              ...
              ptrX1 = advancePtr ptr 2
              ptrY1 = advancePtr ptr 3
          ios_keysTouchHandlePointDrop ptrTicks
                                           ptrX0
                                           ptrY0
                                           ptrX1
                                           ptrY1    >>= \value -> case value of
...
-- | 
foreign import ccall unsafe "ios_keysTouchHandleCircleTouched"
    ios_keysTouchHandleCircleTouched
...
keysTouchHandleCircleTouched a f = io $ 
    allocaArray 3 $ \ptr -> do
        ...
        ios_keysTouchHandleCircleTouched ptrX 
                                             ptrY
...
-- |
foreign import ccall unsafe "ios_keysTouchHandleCircleReleased"
    ios_keysTouchHandleCircleReleased
    :: Ptr CFloat -> Ptr CFloat -> Ptr CFloat -> IO CUInt
...
keysTouchHandleCircleReleased a f = io $ 
    allocaArray 3 $ \ptr -> do
        let ptrX = advancePtr ptr 0
            ptrY = advancePtr ptr 1
            ptrRadius = advancePtr ptr 2
        ios_keysTouchHandleCircleReleased ptrX 
                                              ptrY
                                              ptrRadius >>= \value -> case value of
            0   -> return a
            _   -> do
...
-- |
foreign import ccall unsafe "ios_keysTouchHandleCircleDrag"
    ios_keysTouchHandleCircleDrag
...
keysTouchHandleCircleDrag a f = io $ 
    alloca $ \ptrTicks -> 
      allocaArray 6 $ \ptr -> do
          ...
          ios_keysTouchHandleCircleDrag ptrTicks
                                            ptrX0
                                            ptrY0
                                            ptrRadius0
                                            ptrX1
...
-- |
foreign import ccall unsafe "ios_keysTouchHandleCircleDrop"
    ios_keysTouchHandleCircleDrop
    :: Ptr CDouble -> Ptr CFloat -> Ptr CFloat -> Ptr CFloat ->
                      Ptr CFloat -> Ptr CFloat -> Ptr CFloat -> IO CUInt
    ...
    alloca $ \ptrTicks -> 
      allocaArray 6 $ \ptr -> do
          let ptrX0 = advancePtr ptr 0
              ...
              ptrY1 = advancePtr ptr 4
              ptrRadius1 = advancePtr ptr 5
          ios_keysTouchHandleCircleDrop ptrTicks
                                            ptrX0
                                            ptrY0
                                            ptrRadius0
                                            ptrX1
...
foreign import ccall unsafe "ios_keysTouchHandleButtonA"
    ios_keysTouchHandleButtonA
    :: Ptr CFloat -> Ptr CFloat -> IO CUInt
...
keysTouchHandleButtonA a f = io $ 
    allocaArray 2 $ \ptr -> do
        let ptrX = advancePtr ptr 0
            ptrY = advancePtr ptr 1
        ios_keysTouchHandleButtonA ptrX ptrY >>= \value -> case value of
            0   -> return a
            _   -> do
              x <- peek ptrX
              y <- peek ptrY
...
foreign import ccall unsafe "ios_keysTouchHandleButtonB" ios_keysTouchHandleButtonB
    :: Ptr CFloat -> Ptr CFloat -> IO CUInt
...
keysTouchHandleButtonB a f = io $ 
    allocaArray 2 $ \ptr -> do
        let ptrX = advancePtr ptr 0
            ptrY = advancePtr ptr 1
        ios_keysTouchHandleButtonB ptrX ptrY >>= \value -> case value of
            0   -> return a
            _   -> do
              x <- peek ptrX
              y <- peek ptrY
...
foreign import ccall unsafe "ios_keysAcclGyro" ios_keysAcclGyro
...
keysAcclGyro = io $ do
    allocaArray 6 $ \ptr -> do
      ios_keysAcclGyro (ptr `advancePtr` 0)
                       (ptr `advancePtr` 1)
                       (ptr `advancePtr` 2)
                       (ptr `advancePtr` 3)
                       (ptr `advancePtr` 4)
