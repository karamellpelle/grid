...
--
module Game.Grid.Output.Fancy.ShadeSpaceBox
  (
    shadeSpaceBox,
    shadeSpaceBoxColor,
...
import Game.Grid.GridData.Fancy.ShadeSpaceBox
...
shadeSpaceBox sh alpha projmodv proj radius = 
    shadeSpaceBoxColor sh alpha projmodv proj radius valueSpaceBoxDefaultColor
